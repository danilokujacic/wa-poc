...
export class AddUserAndEmailConfirmation1784414267769 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."user_role_enum" AS ENUM('Owner', 'Employee')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "email_confirmation" ("id" SERIAL NOT NULL, "slug" character varying NOT NULL, "code" character varying NOT NULL, "expires" TIMESTAMP NOT NULL, "userId" uuid, CONSTRAINT "UQ_03477ebd2e20e4fc7b8741a5f86" UNIQUE ("slug"), CONSTRAINT "PK_ff2b80a46c3992a0046b07c5456" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `ALTER TABLE "user" ADD CONSTRAINT "FK_bd5f9fcc9a646e0787cb02b868c" FOREIGN KEY ("resortId") REFERENCES "resort"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "user" DROP CONSTRAINT "FK_bd5f9fcc9a646e0787cb02b868c"`,
    );
