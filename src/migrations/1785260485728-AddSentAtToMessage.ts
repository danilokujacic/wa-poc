...
export class AddSentAtToMessage1785260485728 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "message" ADD "sentAt" TIMESTAMP WITH TIME ZONE`);
        ...
        await queryRunner.query(`UPDATE "message" SET "sentAt" = "createdAt" WHERE "sentAt" IS NULL`);
        await queryRunner.query(`ALTER TABLE "message" ALTER COLUMN "sentAt" SET NOT NULL`);
    }
