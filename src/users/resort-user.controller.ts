...
export class ResortUserController {
  ...
  @ApiOperation({
    summary: "List a resort's users — only its owner or employees may do this",
  })
  @ApiParam({ name: 'resortId', type: String })
  ...
  @ApiOperation({
    summary:
      "Get one of a resort's users — only its owner or employees may do this",
  })
  @ApiParam({ name: 'resortId', type: String })
  ...
  @ApiOperation({
    summary:
      "Delete one of a resort's users — only its owner, or the user themselves, may do this",
  })
  @ApiParam({ name: 'resortId', type: String })
  @ApiParam({ name: 'userId', type: String })
